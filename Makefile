...
deploy: install-linux
	rsync -e 'ssh -l ec2-user -i /Users/cgansen/.ssh/cgansen-aws.pem' -avz ~/go/bin/linux_amd64/{api,loader} create_index.sh data tmpl ec2-user@api.healthnear.me:/var/www/healthnearme-api
